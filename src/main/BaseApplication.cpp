...
bool BaseApplication::configure(void)
{
    ...
    if(mRoot->showConfigDialog())
    {
        ...
        mWindow = mRoot->initialise(true, "ROgre");
...
{
    InputManager::getInstance().keyReleased(arg);
    return true;
}

bool BaseApplication::mouseMoved( const OIS::MouseEvent &arg )
{
    InputManager::getInstance().mouseMoved(arg);
    return true;
}

bool BaseApplication::mousePressed( const OIS::MouseEvent &arg, OIS::MouseButtonID id )
{
    InputManager::getInstance().mousePressed(arg, id);
    return true;
}

bool BaseApplication::mouseReleased( const OIS::MouseEvent &arg, OIS::MouseButtonID id )
{
    InputManager::getInstance().mouseReleased(arg, id);
    return true;
}
